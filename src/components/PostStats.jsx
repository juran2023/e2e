...
export function PostStats({ postId }) {
  ...
  if (
    ...
    console.log(`totalViews is loading: ${totalViews.isLoading}`)
    console.log(`dailyViews is loading: ${dailyViews.isLoading}`)
    console.log(`dailyDurations is loading: ${dailyDurations.isLoading}`)
